...
> Note: RTX 50-series / Blackwell GPUs such as RTX 5060 Ti cannot use the
> PyTorch 1.10.1 + CUDA 11.3 stack above. See
> [RTX5060TI_SETUP.md](RTX5060TI_SETUP.md) for the CUDA 12.8 setup.
